...
![Создание пресета](screenshots/creation-preset.jpg)

Создание и редактирование пресета: название, папка, теги, тип заметки и другие параметры шаблона сохраняются в пресет для последующего применения.
